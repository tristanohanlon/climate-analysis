...
f = Dataset('clt_Amon_MRI-CGCM3_amip_r1i1p1_197901-201002.nc', 'r')

#get latitude
lat = np.array(f.variables['lat'][:])

#get total cloud cover keyed to latitude
tcc = np.array(f.variables['clt'][326:350])
...
#get cloud fraction
f = Dataset('cl_Amon_MRI-CGCM3_amip_r1i1p1_199901-200812.nc', 'r')
...
f = Dataset('ps_Amon_MRI-CGCM3_amip_r1i1p1_197901-201002.nc', 'r')
ps = np.array(f.variables['ps'][326:350]) #in hPa
f.close()
...
f = Dataset('clw_Amon_MRI-CGCM3_amip_r1i1p1_199901-200812.nc', 'r')
...
f = Dataset('cli_Amon_MRI-CGCM3_amip_r1i1p1_199901-200812.nc', 'r')
iw = np.array(f.variables['cli'][96:])
iw = np.mean(iw, axis = 0)
f.close()

#get temperature
f = Dataset('ta_Amon_MRI-CGCM3_amip_r1i1p1_199901-200812.nc', 'r')
...
os.chdir('E:/University/University/MSc/Models/climate-analysis/MRI-CGCM3-AMIP/reduced_datasets/backup_reduced_datasets')
b = h5py.File('2007_2008_mri_cgcm3.h5', 'r')
...
#os.chdir('c:/Users/tristan/University/University/MSc/Models/climate-analysis/MRI-CGCM3-AMIP/reduced_datasets') #Home PC
os.chdir('E:/University/University/MSc/Models/climate-analysis/MRI-CGCM3-AMIP/reduced_datasets') #Home PC
with h5py.File('2007_2008_mri_cgcm3.h5', 'w') as p:
