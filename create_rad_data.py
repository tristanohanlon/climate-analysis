...
import constants
import statistics
import model_rad_lat_dt # change to model_rad for pre average
...
liquid_r = 12 # above 2.5, below 60 microns - best ensemble result with 23, 35 for SO (12 for dt, 20 for dt SO)
ice_r = 60 # above 15, below 130 - best ensemble result with 60 (also with dt and dt so), 110 for SO

model_rad_lat_dt.radiation( start, 
                    end,
                    start_dt, 
                    end_dt, 
                    location, 
