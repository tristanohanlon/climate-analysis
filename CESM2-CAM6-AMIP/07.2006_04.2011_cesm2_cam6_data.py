...
tcc1 = np.array(f.variables['CLDTOT'][678:732])
tcc2 = np.array(f.variables['CLDTOT'][733:736])
...
cf2 = np.array(f.variables['CLOUD'][733:736])
...
lw1 = np.array(f.variables['CLDLIQ'][678:732]) # get values from 07.2006 to 12.2010
