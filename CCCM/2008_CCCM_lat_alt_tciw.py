...
os.chdir('//Synthesis/E/University/University/MSc/Models/climate-analysis/CCCM/raw_datasets') #Lounge
...
os.chdir('//Synthesis/E/University/University/MSc/Models/Data/CCCM/2008')  # Lounge
...
ax.contourf(unique ,alt, cccm_tciw_lat)
...
plt.title('IWP vs Latitude - 2008')
plt.show()


#import h5py

os.chdir('C:/Users/Tristan/Desktop')
# specify path and file name to create 
with h5py.File('2008_CCCM_tciw_lat_alt.h5', 'w') as p:
