...
os.chdir('//Synthesis/E/University/University/MSc/Models/Data/CCCM/2011')  # Lounge
...
plt.title('IWP vs Latitude - 2011')
plt.show()
...
with h5py.File('2011_CCCM_tciw_lat_alt.h5', 'w') as p:
