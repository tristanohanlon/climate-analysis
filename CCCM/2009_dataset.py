...
os.chdir('d:/Downloads/CCCM/2009')  # Home PC
...
with h5py.File('2009_raw_data.h5', 'w') as p:
...
f = h5py.File('2009_raw_data.h5', 'r')
...
os.chdir('//synthesis/e/University/University/MSc/Models/Data/CCCM/raw_data')
with h5py.File('2009_cloud_fractions.h5', 'w') as p:
...
"""    
os.chdir('//synthesis/e/University/University/MSc/Models/Data/CCCM/raw_data')
f = h5py.File('2009_cloud_fractions.h5', 'r')
...
f = h5py.File('2009_cccm85_enhanced_lwc.h5', 'r')
...
os.chdir('e:/University/University/MSc/Models/Data/CCCM/raw_data')  # Home PC
f = h5py.File('2009_cccm86_enhanced_iwc.h5', 'r')
...
f = h5py.File('2009_CCCM_profile_variables.h5', 'r')
...
os.chdir('e:/University/University/MSc/Models/climate-analysis/CCCM/reduced_datasets')  # Home PC
with h5py.File('2009_data_new.h5', 'w') as p:
