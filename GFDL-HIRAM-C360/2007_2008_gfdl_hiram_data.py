...
tcc = np.array(f.variables['clt'][36:])
...
ps = np.array(f.variables['ps'][36:]) #in hPa
...
os.chdir('E:/University/University/MSc/Models/climate-analysis/GFDL-HIRAM-C360/reduced_datasets') #Home PC
with h5py.File('2007_2008_gfdl_hiram.h5', 'w') as p:
