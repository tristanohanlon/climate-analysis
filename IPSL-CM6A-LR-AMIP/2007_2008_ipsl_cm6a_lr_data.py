...
tcc = np.array(f.variables['clt'][336:360])
...
cf = np.array(f.variables['cl'][336:360])
...
ps = np.array(f.variables['ps'][336:360]) #in hPa
f.close()
...
lw = np.array(f.variables['clw'][336:360])
...
with h5py.File('2007_2008_ipsl_cm6a_lr.h5', 'w') as p:
