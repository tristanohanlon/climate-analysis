...
"""
os.chdir('//synthesis/e/University/University/MSc/Models/climate-analysis/IPSL-CM6A-LR-AMIP/reduced_datasets/')
b = h5py.File('2001_2005_ipsl_cm6a_lr.h5', 'r')
...
os.chdir('//synthesis/e/University/University/MSc/Models/Data/CMIP6/ipsl_cm6a_lr_amip') #Home PC
#os.chdir('D:/MSc/Models/Data/CMIP6/ipsl_cm6a_lr_amip') #ext HDD

f = Dataset('clt_Amon_IPSL-CM6A-LR_amip_r1i1p1f1_gr_197901-201412.nc', 'r')
...
tcc2 = np.array(f.variables['clt'][384:387])
...
#get cloud fraction
f = Dataset('cl_Amon_IPSL-CM6A-LR_amip_r1i1p1f1_gr_197901-201412.nc', 'r')
cf1 = np.array(f.variables['cl'][330:384])
cf2 = np.array(f.variables['cl'][384:387])
cf = np.concatenate((cf1,cf2))
cf = np.mean(cf, axis = 0) / 100


#get hybrid pressure levels
plev = np.array(f.variables['presnivs'][:]) #in hPa
a = np.array(f.variables['ap'][:79]) #in hPa
b = np.array(f.variables['b'][:79]) #in hPa
#p0 = np.array(f.variables['p0'][:]) #in hPa
f.close()


f = Dataset('ps_Amon_IPSL-CM6A-LR_amip_r1i1p1f1_gr_197901-201412.nc', 'r')
ps1 = np.array(f.variables['ps'][330:384]) #in hPa
ps2 = np.array(f.variables['ps'][384:387])
...
f = Dataset('clw_Amon_IPSL-CM6A-LR_amip_r1i1p1f1_gr_197901-201412.nc', 'r')
lw1 = np.array(f.variables['clw'][330:384])
lw2 = np.array(f.variables['clw'][384:387])
...
f = Dataset('cli_Amon_IPSL-CM6A-LR_amip_r1i1p1f1_gr_197901-201412.nc', 'r')
iw1 = np.array(f.variables['cli'][330:384])
iw2 = np.array(f.variables['cli'][384:387])
iw = np.concatenate((iw1,iw2))
iw = np.mean(iw, axis = 0)
f.close()

#get temperature
f = Dataset('ta_Amon_IPSL-CM6A-LR_amip_r1i1p1f1_gr_197901-201412.nc', 'r')
T1 = np.array(f.variables['ta'][330:384])
T2 = np.array(f.variables['ta'][384:387])
...
os.chdir('E:/University/University/MSc/Models/climate-analysis/IPSL-CM6A-LR-AMIP/reduced_datasets') #Home PC
#os.chdir('c:/Users/toha006/University/University/MSc/Models/climate-analysis/IPSL-CM5A-LR-AMIP/reduced_datasets') #Home PC
with h5py.File('07.2006_04.2011_ipsl_cm6a_lr.h5', 'w') as p:
