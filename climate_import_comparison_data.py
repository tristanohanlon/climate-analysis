...
This import the reduced datasets from Five Year Climate CCCM, ECMWF and gfdl4. 
...
j = h5py.File('07.2006_04.2011_cccm.h5', 'r')
...
cccm_tcc_lat_g = j['tcc'][:] # 0-1
cccm_tcc_lat_g_enhanced  = j['tcc_enhanced'][:] # 0-1
cccm_tclw_lat_g = j['tclw'][:] #kgm^-2
cccm_tciw_lat_g = j['tciw'][:] #kgm^-2
...
cccm_tclw_frac_lat_g = j['tclw_frac'][:]
cccm_tciw_frac_lat_g = j['tciw_frac'][:]
cccm_tclw_frac_lat_g_enhanced = j['tclw_frac_enhanced'][:]
cccm_tciw_frac_lat_g_enhanced = j['tclw_frac_enhanced'][:]

#---CCCM Global Profile---#

cccm_tcc_alt_g = j['cf'][:] # 0-1 4:101
cccm_tclw_alt_g = j['lw'][:113] #kg/kg 4:63
cccm_tciw_alt_g = j['iw'][:113] #kg/kg 4:93
cccm_temp_alt_g = j['temp'][:] #K
cccm_plevel_alt_g = j['pressure'][:] #hPa

cccm_tcc_temp_g = j['cf_t'][:] # 0-1
cccm_tclw_temp_g = j['lw_t'][:] #kg/kg
cccm_tciw_temp_g = j['iw_t'][:] #kg/kg

cccm_tclw_frac_alt_g = j['lw_frac'][:]
cccm_tciw_frac_alt_g = j['iw_frac'][:]

#---CCCM Temperature Phase Fractions---#

cccm_tclw_frac_temp_g = j['lw_frac_temp'][:]
cccm_tciw_frac_temp_g = j['iw_frac_temp'][:]

cccm_tclw_frac_temp_so = j['lw_frac_temp_so'][:]
cccm_tciw_frac_temp_so = j['iw_frac_temp_so'][:]


#---CCCM Southern Ocean Profile---#

cccm_tcc_alt_so = j['cf_so'][:] # 0-1
cccm_tclw_alt_so = j['lw_so'][:] #kg/kg
cccm_tciw_alt_so = j['iw_so'][:] #kg/kg
cccm_temp_alt_so = j['temp_so'][:] #K
cccm_plevel_alt_so = j['pressure_so'][:] #hPa

cccm_tcc_temp_so = j['cf_t_so'][:] # 0-1
cccm_tclw_temp_so = j['lw_t_so'][:] #kg/kg
cccm_tciw_temp_so = j['iw_t_so'][:] #kg/kg

cccm_tclw_frac_alt_so = j['lw_frac_so'][:]
cccm_tciw_frac_alt_so = j['iw_frac_so'][:]
...
ax2.plot(ecmwf_tclw_frac_temp_g[18:,0],ecmwf_tclw_frac_temp_g[18:,1], '-k', label='Global - ECMWF-ERA5')
...
ax1.set_title('Five Year Climate Global Liquid Cloud Fraction vs Temperature')

ax1.grid(True)
ax2.grid(True)
plt.savefig("climate_global_liquid_T.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
ax1.set_title('Five Year Climate Southern Ocean Liquid Cloud Fraction vs Temperature')

ax1.grid(True)
ax2.grid(True)
plt.savefig("climate_so_liquid_T.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
ax1.set_title ('Five Year Climate Global Cloud Fraction vs Latitude')

ax1.grid(True)
ax2.grid(True)
plt.savefig("climate_tcc_lat_g.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
ax1.plot(ecmwf_tclw_frac_lat_g[:,0],ecmwf_tclw_frac_lat_g[:,1], ':k', label='ECMWF-ERA5')
...
ax2.plot(ecmwf_tclw_frac_lat_g[:,0],ecmwf_tclw_frac_lat_g[:,1], ':k', label='ECMWF-ERA5')
...
ax1.set_title('Five Year Climate Global Liquid Fractions of Clouds vs Latitude')

ax1.grid(True)
ax2.grid(True)
plt.savefig("climate_tclw_lat_g.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate Global Ice Fractions of Clouds vs Latitude')

plt.grid(True)
plt.savefig("climate_tciw_lat_frac_g.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
ax2.plot(cccm_tcc_alt_g[4:92,1],cccm_tcc_alt_g[4:92,0], ':r', label='Global - CCCM')
ax2.plot(calipso_tcc_alt_g[:,1],calipso_tcc_alt_g[:,0], ':b', label='Global - CALIPSO')
ax2.plot(ecmwf_tcc_alt_g[:,1],ecmwf_tcc_alt_g[:,0], '-k', label='Global - ECMWF-ERA5')
...
ax1.set_title('Five Year Climate Global Cloud Fraction vs Altitude')
...
plt.savefig("climate_tcc_alt_g.svg", format="svg", bbox_inches='tight')
...
ax2.plot(cccm_tclw_frac_alt_g[4:61,1],cccm_tclw_frac_alt_g[4:61,0], ':r', label='Global - CCCM')
ax2.plot(calipso_tclw_frac_alt_g[:21,1],calipso_tclw_frac_alt_g[:21,0], ':b', label='Global - CALIPSO')
ax2.plot(ecmwf_tclw_frac_alt_g[15:,1],ecmwf_tclw_frac_alt_g[15:,0], '-k', label='Global - ECMWF-ERA5')
...
ax1.set_title('Five Year Climate Global Cloud Liquid Water Fraction vs Altitude')
...
ax1.grid(True)
ax2.grid(True)
plt.savefig("climate_tclw_frac_alt_g.svg", format="svg", bbox_inches='tight')
...
plt.title('Five Year Climate Cloud Ice Water Fraction vs Altitude')

plt.grid(True)
plt.savefig("climate_tciw_frac_alt_g.svg", format="svg", bbox_inches='tight')
...
ax1.plot(ecmwf_tcc_alt_so[:,1],ecmwf_tcc_alt_so[:,0], '-k', label='ECMWF-ERA5')
...
ax2.plot(ecmwf_tcc_alt_so[:,1],ecmwf_tcc_alt_so[:,0], '-k', label='ECMWF-ERA5')
...
ax1.set_title('Five Year Climate Southern Ocean Cloud Fraction vs Altitude')
...
plt.savefig("climate_tcc_alt_so.svg", format="svg", bbox_inches='tight')
...
ax1.plot(calipso_tclw_frac_alt_so[:20,1],calipso_tclw_frac_alt_so[:20,0], ':b', label='CALIPSO')
#ax1.plot(ecmwf_tclw_frac_alt_so[:,1],ecmwf_tclw_frac_alt_so[:,0], '-k', label='ECMWF-ERA5')
...
ax2.plot(calipso_tclw_frac_alt_so[:20,1],calipso_tclw_frac_alt_so[:20,0], ':b', label='CALIPSO')
#ax2.plot(ecmwf_tclw_frac_alt_so[:,1],ecmwf_tclw_frac_alt_so[:,0], '-k', label='ECMWF-ERA5')
...
ax1.set_title('Five Year Climate Southern Ocean Cloud Liquid Water Fraction vs Altitude')
...
ax1.grid(True)
ax2.grid(True)
plt.savefig("climate_tclw_frac_alt_so.svg", format="svg", bbox_inches='tight')
...
plt.title('Five Year Climate Cloud Ice Water Fraction over the Southern Ocean vs Altitude')
...
plt.title('Five Year Climate ECMWF-ERA5 Cloud Liquid Water Fraction')

plt.savefig("climate_contour_ecmwf_tclw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate ECMWF-ERA5 Cloud Ice Water Fraction')

plt.savefig("climate_contour_ecmwf_tciw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate GFDL-HIRAM-AMIP Cloud Liquid Water Fraction')

plt.savefig("climate_contour_gfdl_hiram_tclw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate GFDL-HIRAM-AMIP Cloud Ice Water Fraction')

plt.savefig("climate_contour_gfdl_hiram.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate GFDL-AM4-AMIP Cloud Liquid Water Fraction')

plt.savefig("climate_contour_gfdl4_tclw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate GFDL-AM4-AMIP Cloud Ice Water Fraction')

plt.savefig("climate_contour_gfdl4_tciw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate MRI-CGCM3-AMIP Cloud Liquid Water Fraction')

plt.savefig("climate_contour_mri_cgcm_tclw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate MRI-CGCM3-AMIP Cloud Ice Water Fraction')

plt.savefig("climate_contour_mri_cgcm_tciw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate MRI_ESM2-AMIP Cloud Liquid Water Fraction')

plt.savefig("climate_contour_mri_tclw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate MRI_ESM2-AMIP Cloud Ice Water Fraction')

plt.savefig("climate_contour_mri_tciw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate CESM2-CAM6-AMIP Cloud Liquid Water Fraction')

plt.savefig("climate_contour_cam6_tclw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate CESM2-CAM6-AMIP Cloud Ice Water Fraction')

plt.savefig("climate_contour_cam6_tciw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate CESM1-CAM5-AMIP Cloud Liquid Water Fraction')

plt.savefig("climate_contour_cam5_tclw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
...
plt.title('Five Year Climate CESM1-CAM5-AMIP Cloud Ice Water Fraction')

plt.savefig("climate_contour_cam5_tciw.svg", format="svg", bbox_inches='tight')
plt.show()
"""
