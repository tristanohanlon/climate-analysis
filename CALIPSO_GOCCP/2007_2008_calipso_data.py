...
#opaque (thick) clouds
cc = np.array(f.variables['cltcalipso_opaque'][84:108]) # 2007 to 2008 - 24 months
...
#thin clouds
tf = np.array(f.variables['cltcalipso_thin'][84:108]) # 2007 to 2008 - 24 months
...
#ice water fraction
ice = np.array(f.variables['clcalipso_RPIC'][84:108]) # 2007 to 2008 - 24 months
...
ax1.plot(lat,tcc, '-r', label='Cloud Fraction')
...
cff = np.array(f.variables['clcalipso'][84:108]) # 2007 to 2008 - 24 months
...
cf_t = np.array(f.variables['cltemp'][84:108]) # 2007 to 2008 - 24 months
...
iw_t = np.array(f.variables['cltemp_phase'][84:108]) # 2007 to 2008 - 24 months
...
with h5py.File('2007_2008_calipso.h5', 'w') as p:
