...
tcc = np.array(f.variables['clt'][672:696])
...
cf = np.array(f.variables['cl'][672:696])
...
ps = np.array(f.variables['ps'][672:696]) #in hPa
f.close()
...
lw = np.array(f.variables['clw'][672:696])
...
with h5py.File('2007_2008_giss_e2r.h5', 'w') as p:
