...
"""
os.chdir('//synthesis/e/University/University/MSc/Models/climate-analysis/GISS-E21G-AMIP/reduced_datasets/')
b = h5py.File('2001_2005_giss_e21g.h5', 'r')
...
os.chdir('//synthesis/e/University/University/MSc/Models/Data/CMIP6/nasa_giss_e21g_amip') #Home PC
#os.chdir('D:/MSc/Models/Data/CMIP6/ipsl_cm6a_lr_amip') #ext HDD

f = Dataset('clt_Amon_GISS-E2-1-G_amip_r1i1p1f1_gn_200101-201412.nc', 'r')

#get latitude
lat = np.array(f.variables['lat'][:])

#get total cloud cover keyed to latitude
tcc1 = np.array(f.variables['clt'][66:120])
tcc2 = np.array(f.variables['clt'][120:123])
...
#get cloud fraction
f = Dataset('cl_Amon_GISS-E2-1-G_amip_r1i1p1f1_gn_200101-201412.nc', 'r')
cf1 = np.array(f.variables['cl'][66:120])
cf2 = np.array(f.variables['cl'][120:123])
...
f = Dataset('ps_Amon_GISS-E2-1-G_amip_r1i1p1f1_gn_200101-201412.nc', 'r')
ps1 = np.array(f.variables['ps'][66:120]) #in hPa
ps2 = np.array(f.variables['ps'][120:123]) #in hPa
...
f = Dataset('clw_Amon_GISS-E2-1-G_amip_r1i1p1f1_gn_200101-201412.nc', 'r')
lw1 = np.array(f.variables['clw'][66:120])
lw2 = np.array(f.variables['clw'][120:123])
...
f = Dataset('cli_Amon_GISS-E2-1-G_amip_r1i1p1f1_gn_200101-201412.nc', 'r')
iw1 = np.array(f.variables['cli'][66:120])
iw2 = np.array(f.variables['cli'][120:123])
iw = np.concatenate((iw1,iw2))
iw = np.mean(iw, axis = 0)
f.close()

#get temperature
f = Dataset('ta_Amon_GISS-E2-1-G_amip_r1i1p1f1_gn_200101-201412.nc', 'r')
T1 = np.array(f.variables['ta'][66:120])
T2 = np.array(f.variables['ta'][120:123])
...
os.chdir('E:/University/University/MSc/Models/climate-analysis/GISS-E21G-AMIP/reduced_datasets') #Home PC
#os.chdir('c:/Users/toha006/University/University/MSc/Models/climate-analysis/IPSL-CM5A-LR-AMIP/reduced_datasets') #Home PC
with h5py.File('07.2006_04.2011_giss_e21g.h5', 'w') as p:
