...
b = h5py.File('2007_2008_mri_esm2.h5', 'r')
...
f = Dataset('clt_Amon_MRI-ESM2-0_amip_r1i1p1f1_gn_197901-201412.nc', 'r') # 432 months
...
f = Dataset('cl_Amon_MRI-ESM2-0_amip_r1i1p1f1_gn_199901-200812.nc', 'r') # 120 months
...
f = Dataset('ps_Amon_MRI-ESM2-0_amip_r1i1p1f1_gn_197901-201412.nc', 'r') # 432 months
ps = np.array(f.variables['ps'][336:360])
f.close()
...
f = Dataset('clw_Amon_MRI-ESM2-0_amip_r1i1p1f1_gn_199901-200812.nc', 'r') # 120 months
...
f = Dataset('cli_Amon_MRI-ESM2-0_amip_r1i1p1f1_gn_199901-200812.nc', 'r') # 120 months
...
f = Dataset('ta_Amon_MRI-ESM2-0_amip_r1i1p1f1_gn_197901-201412.nc', 'r') # 432 months
...
with h5py.File('2007_2008_mri_esm2.h5', 'w') as p:
