...
@author: Tristan
    ...
    CMIP5-CESM1-CAM5 : 1979.01-2005.12 --- cl must be dived by 100
    CMIP5-GFDL-CM3 : 1999.01-2008.12
    ...
    CMIP6-GFDL-CM4 : 1980.01-2014.12
...
reduce_dataset is called by:
    (data folder, file name after quantity - referenced in dictionary below [all_amip_models], 
    ...
    if model == 'all_models':
        for model in constants.all_amip_models:
            ...
            reduce_cosp_dataset.reduce_cosp_dataset(
                model, 
                constants.model_dict_amip[ model ], 
