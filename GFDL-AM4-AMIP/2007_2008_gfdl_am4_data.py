...
#os.chdir('D:/MSc/Models/Data/CMIP6/gfdl_am4/') #Home PC

f = Dataset('clt_Amon_GFDL-AM4_amip_r1i1p1f1_gr1_198001-201412.nc', 'r') # 420 months
tcc = np.array(f.variables['clt'][324:348])
...
f = Dataset('cl_Amon_GFDL-AM4_amip_r1i1p1f1_gr1_198001-201412.nc', 'r') # 120 months
cf = np.array(f.variables['cl'][324:348])
...
f = Dataset('ps_Amon_GFDL-AM4_amip_r1i1p1f1_gr1_198001-201412.nc', 'r') # 432 months
ps = np.array(f.variables['ps'][324:348])
f.close()
...
f = Dataset('clw_Amon_GFDL-AM4_amip_r1i1p1f1_gr1_198001-201412.nc', 'r') # 120 months
lw = np.array(f.variables['clw'][324:348])
lw = np.mean(lw, axis = 0)
f.close()

#---get iw---#

f = Dataset('cli_Amon_GFDL-AM4_amip_r1i1p1f1_gr1_198001-201412.nc', 'r') # 120 months
iw = np.array(f.variables['cli'][324:348])
...
f = Dataset('ta_Amon_GFDL-AM4_amip_r1i1p1f1_gr1_198001-201412.nc', 'r') # 432 months
T = np.array(f.variables['ta'][324:348])
T[T > 400] = np.nan
...
with h5py.File('2007_2008_gfdl_am4.h5', 'w') as p:
