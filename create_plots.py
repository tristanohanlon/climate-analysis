...
# clim_plot.cloud_temp_plot_models( [ clim_plot.cosp_models[ 'CMIP5-AMIP-GFDL-CM3'], 
#                                     clim_plot.cosp_models[ 'CMIP6-AMIP-GFDL-CM4'], 
#                                     clim_plot.cosp_models[ 'CMIP5-AMIP-CESM1-CAM5'], 
#                                     clim_plot.cosp_models[ 'CMIP6-AMIP-CESM2-CAM6'], 
...
# plot clw_t with temperature - 2 graphs: top = global, bottom = southern ocean
# clim_plot.ice_temp_plot_models( [ clim_plot.models[ 'CMIP5-AMIP-GFDL-CM3'], 
#                                     clim_plot.cosp_models[ 'CMIP6-AMIP-GFDL-CM4'], 
#                                     clim_plot.models[ 'CMIP5-AMIP-CESM1-CAM5'], 
#                                     clim_plot.cosp_models[ 'CMIP6-AMIP-CESM2-CAM6'],
...
clim_plot.model_cli_contours( [ clim_plot.cosp_models[ 'CMIP6-AMIP-CESM2-CAM6'], clim_plot.cosp_models[ 'CMIP6-AMIP-GFDL-CM4'] ], [ 6, 6 ] )
