...
os.chdir('//synthesis/e/University/University/MSc/Models/Data/CMIP6/miroc6_amip') #Home PC
#os.chdir('D:/MSc/Models/Data/CMIP6/ipsl_cm6a_lr_amip') #ext HDD

f = Dataset('clt_Amon_MIROC6_amip_r1i1p1f1_gn_197901-201412.nc', 'r')
...
#get cloud fraction
f = Dataset('cl_Amon_MIROC6_amip_r1i1p1f1_gn_199901-200812.nc', 'r')
cf1 = np.array(f.variables['cl'][90:])
f.close()
f = Dataset('cl_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
cf2 = np.array(f.variables['cl'][:24])
f.close()
f = Dataset('cl_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
cf3 = np.array(f.variables['cl'][24:27])
...
f = Dataset('ps_Amon_MIROC6_amip_r1i1p1f1_gn_197901-201412.nc', 'r')
...
f = Dataset('clw_Amon_MIROC6_amip_r1i1p1f1_gn_199901-200812.nc', 'r')
lw1 = np.array(f.variables['clw'][90:])
f.close()
f = Dataset('clw_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
lw2 = np.array(f.variables['clw'][:24])
f.close()
f = Dataset('clw_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
lw3 = np.array(f.variables['clw'][24:27])
...
f = Dataset('cli_Amon_MIROC6_amip_r1i1p1f1_gn_199901-200812.nc', 'r')
iw1 = np.array(f.variables['cli'][90:])
f.close()
f = Dataset('cli_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
iw2 = np.array(f.variables['cli'][:24])
f.close()
f = Dataset('cli_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
iw3 = np.array(f.variables['cli'][24:27])
iw = np.concatenate((iw1,iw2,iw3))
iw = np.mean(iw, axis = 0)
f.close()

#get temperature
f = Dataset('ta_Amon_MIROC6_amip_r1i1p1f1_gn_199901-200812.nc', 'r')
T1 = np.array(f.variables['ta'][90:])
f.close()
f = Dataset('ta_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
T2 = np.array(f.variables['ta'][:24])
f.close()
f = Dataset('ta_Amon_MIROC6_amip_r1i1p1f1_gn_200901-201412.nc', 'r')
T3 = np.array(f.variables['ta'][24:27])
...
os.chdir('E:/University/University/MSc/Models/climate-analysis/MIROC6-AMIP/reduced_datasets') #Home PC
#os.chdir('c:/Users/toha006/University/University/MSc/Models/climate-analysis/IPSL-CM5A-LR-AMIP/reduced_datasets') #Home PC
with h5py.File('07.2006_04.2011_miroc6.h5', 'w') as p:
