...
"""
os.chdir('//synthesis/e/University/University/MSc/Models/climate-analysis/MIROC6-AMIP/reduced_datasets/')
b = h5py.File('07.2006_04.2011_miroc6.h5', 'r')
...
lw = np.array(f.variables['clw'][96:])
...
with h5py.File('2007_2008_miroc6.h5', 'w') as p:
