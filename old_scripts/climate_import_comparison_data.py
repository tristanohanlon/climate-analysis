...
#ECMWF-ERA5 Data
a = h5py.File('ECMWF-ERA5/reduced_datasets/07.2006_04.2011_ecmwf_era5.h5', 'r')

#GFDL-AM4-AMIP Data
b = h5py.File('GFDL-AM4-AMIP/reduced_datasets/07.2006_04.2011_gfdl_am4.h5', 'r')

#GFDL-HIRAM-C360 Data
h = h5py.File('GFDL-HIRAM-C360/reduced_datasets/2001_2005_gfdl_hiram.h5', 'r')

#CCCM Data
c = h5py.File('CCCM/reduced_datasets/07.2006_04.2011_cccm.h5', 'r')

#MRI-ESM2-AMIP Data
d = h5py.File('MRI-ESM2-AMIP/reduced_datasets/07.2006_04.2011_mri_esm2.h5', 'r')

#MRI-CGCM3-AMIP Data
i = h5py.File('MRI-CGCM3-AMIP/reduced_datasets/2001_2005_mri_cgcm3.h5', 'r')

#CESM1-CAM5-AMIP Data
p = h5py.File('CESM1-CAM5-AMIP/reduced_datasets/2001_2005_cesm1_cam5.h5', 'r')

#CESM2-CAM6-AMIP Data
e = h5py.File('CESM2-CAM6-AMIP/reduced_datasets/07.2006_04.2011_cesm2_cam6.h5', 'r')

#CAPLISO Data
f = h5py.File('CALIPSO_GOCCP/reduced_datasets/07.2006_04.2011_calipso.h5', 'r')

#CERES Data
g = h5py.File('CERES/reduced_datasets/07.2006_04.2011_ceres.h5', 'r')

#GISS-E2R-AMIP Data
j = h5py.File('GISS-E2R-AMIP/reduced_datasets/2001_2005_giss_e2r.h5', 'r')

#GISS-E21G-AMIP Data
k = h5py.File('GISS-E21G-AMIP/reduced_datasets/07.2006_04.2011_giss_e21g.h5', 'r')

#IPSL-CM5A-LR-AMIP Data
l = h5py.File('IPSL-CM5A-LR-AMIP/reduced_datasets/2001_2005_ipsl_cm5a_lr.h5', 'r')

#IPSL-CM6A-LR-AMIP Data
m = h5py.File('IPSL-CM6A-LR-AMIP/reduced_datasets/07.2006_04.2011_ipsl_cm6a_lr.h5', 'r')

#MIROC5-AMIP Data
n = h5py.File('MIROC5-AMIP/reduced_datasets/2001_2005_miroc5.h5', 'r')

#MIROC6-AMIP Data
o = h5py.File('MIROC6-AMIP/reduced_datasets/07.2006_04.2011_miroc6.h5', 'r')
...
ax2.plot(cam6_tcc_lat_g[:,0],cam6_tcc_lat_g[:,1], '-m', label='CMIP6-CESM2-CAM6-AMIP')
