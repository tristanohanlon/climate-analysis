...
"""
os.chdir('//synthesis/e/University/University/MSc/Models/climate-analysis/GISS-E2R-AMIP/reduced_datasets/')
b = h5py.File('2007_2008_giss_e2r.h5', 'r')
...
os.chdir('//synthesis/e/University/University/MSc/Models/Data/CMIP5/nasa_giss_e2r_amip') #Home PC
#os.chdir('D:/MSc/Models/Data/CMIP6/ipsl_cm6a_lr_amip') #ext HDD

f = Dataset('clt_Amon_GISS-E2-R_amip_r1i1p1_195101-201012.nc', 'r')

#get latitude
lat = np.array(f.variables['lat'][:])

#get total cloud cover keyed to latitude
tcc = np.array(f.variables['clt'][600:660])
...
#get cloud fraction
f = Dataset('cl_Amon_GISS-E2-R_amip_r1i1p1_195101-201012.nc', 'r')
cf = np.array(f.variables['cl'][600:660])
...
f = Dataset('ps_Amon_GISS-E2-R_amip_r1i1p1_195101-201012.nc', 'r')
ps = np.array(f.variables['ps'][600:660]) #in hPa
f.close()
...
f = Dataset('clw_Amon_GISS-E2-R_amip_r1i1p1_195101-201012.nc', 'r')
lw = np.array(f.variables['clw'][600:660])
lw = np.mean(lw, axis = 0)
f.close()


#get cloud ice content
f = Dataset('cli_Amon_GISS-E2-R_amip_r1i1p1_195101-201012.nc', 'r')
iw = np.array(f.variables['cli'][600:660])
iw = np.mean(iw, axis = 0)
f.close()

#get temperature
f = Dataset('ta_Amon_GISS-E2-R_amip_r1i1p1_195101-201012.nc', 'r')
T = np.array(f.variables['ta'][600:660])
T[T>400] = None
...
os.chdir('E:/University/University/MSc/Models/climate-analysis/GISS-E2R-AMIP/reduced_datasets') #Home PC
#os.chdir('c:/Users/toha006/University/University/MSc/Models/climate-analysis/IPSL-CM5A-LR-AMIP/reduced_datasets') #Home PC
with h5py.File('2001_2005_giss_e2r.h5', 'w') as p:
