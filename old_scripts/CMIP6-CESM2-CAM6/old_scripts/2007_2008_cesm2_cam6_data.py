...
tcc = np.array(f.variables['CLDTOT'][684:708])
...
cf = np.array(f.variables['CLOUD'][684:708])
...
ps = np.array(f.variables['PS'][684:708])
...
b = h5py.File('2007_2008_cesm2_cam6.h5', 'r')
...
lw = np.array(f.variables['CLDLIQ'][684:708])
...
iw = np.array(f.variables['CLDICE'][684:708])
...
T = np.array(f.variables['T'][684:708])
T[T>400] = None
...
with h5py.File('2007_2008_cesm2_cam6.h5', 'w') as p:
