...
a_iw_g = np.mean(a_iw, axis=-1) #Average specific cloud ice water content (kg/kg) over latitude
...
a_lw_g = np.mean(a_lw, axis=-1) #Average specific cloud liquid water content (kg/kg) over latitude
...
b_iw_g = np.mean(b_iw, axis=-1) #Average specific cloud ice water content (kg/kg) over latitude
...
b_lw_g = np.mean(b_lw, axis=-1) #Average specific cloud liquid water content (kg/kg) over latitude
...
c_iw_g = np.mean(c_iw, axis=-1) #Average specific cloud ice water content (kg/kg) over latitude
...
c_lw_g = np.mean(c_lw, axis=-1) #Average specific cloud liquid water content (kg/kg) over latitude
...
d_iw_g = np.mean(d_iw, axis=-1) #Average specific cloud ice water content (kg/kg) over latitude
...
d_lw_g = np.mean(d_lw, axis=-1) #Average specific cloud liquid water content (kg/kg) over latitude
...
e_iw_g = np.mean(e_iw, axis=-1) #Average specific cloud ice water content (kg/kg) over latitude
...
e_lw_g = np.mean(e_lw, axis=-1) #Average specific cloud liquid water content (kg/kg) over latitude
...
f_iw_g = np.mean(f_iw, axis=-1) #Average specific cloud ice water content (kg/kg) over latitude
...
f_lw_g = np.mean(f_lw, axis=-1) #Average specific cloud liquid water content (kg/kg) over latitude
