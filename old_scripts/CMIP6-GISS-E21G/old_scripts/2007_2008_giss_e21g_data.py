...
tcc = np.array(f.variables['clt'][72:96])
...
cf = np.array(f.variables['cl'][72:96])
...
ps = np.array(f.variables['ps'][72:96]) #in hPa
f.close()
...
lw = np.array(f.variables['clw'][72:96])
