...
def reduce_dataset( directory, filename, save_location, start, end):
    ...
    if directory == 'CMIP6-CESM2-CAM6':
        ...
        with Dataset( 'cl' + filename, 'r') as f:
            ...
            cl = np.mean( cl, axis = 0 ) # average over time
            if directory == 'CMIP5-GISS-E2R' or directory == 'CMIP5-IPSL-CM5A-LR' or directory == 'CMIP5-MIROC5' or directory == 'CMIP5-MRI-CGCM3' or directory == 'CMIP6-GFDL-AM4' or directory == 'CMIP6-MIROC6' or directory == 'CMIP6-GISS-E21G' or directory == 'CMIP6-MRI-ESM2' or directory == 'CMIP6-IPSL-CM6A-LR':
                cl = cl / 100 
    ...
    with h5py.File(save_filename, 'w') as p:
        ...
        p.create_dataset('full_clw_alt_lat', data=np.transpose( lw_frac_alt_lat ) ) # total cloud fraction corresponding to alt and lat
