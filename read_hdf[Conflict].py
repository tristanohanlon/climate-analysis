...
f = SD.SD('D:/MSc/Models/Data/CCCM/2006/CER-NEWS_CCCM_Aqua-FM3-MODIS-CAL-CS_RelB1_905905.20060731.hdf') #ext HDD
...
sds_obj = f.select('Cloud free area percent coverage (CALIPSO-CloudSat)') # select sds
