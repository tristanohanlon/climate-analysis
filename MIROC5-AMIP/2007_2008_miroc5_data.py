...
"""
os.chdir('//synthesis/e/University/University/MSc/Models/climate-analysis/MIROC5-AMIP/reduced_datasets/')
b = h5py.File('2001_2005_miroc5.h5', 'r')
...
os.chdir('//synthesis/e/University/University/MSc/Models/Data/CMIP5/miroc5_amip') #Home PC
#os.chdir('D:/MSc/Models/Data/CMIP6/ipsl_cm6a_lr_amip') #ext HDD

f = Dataset('clt_Amon_MIROC5_amip_r1i1p1_197901-200812.nc', 'r')
...
#get cloud fraction
f = Dataset('cl_Amon_MIROC5_amip_r1i1p1_199901-200812.nc', 'r')
...
f = Dataset('ps_Amon_MIROC5_amip_r1i1p1_197901-200812.nc', 'r')
...
f = Dataset('clw_Amon_MIROC5_amip_r1i1p1_199901-200812.nc', 'r')
...
f = Dataset('cli_Amon_MIROC5_amip_r1i1p1_199901-200812.nc', 'r')
iw = np.array(f.variables['cli'][96:])
iw = np.mean(iw, axis = 0)
f.close()

#get temperature
f = Dataset('ta_Amon_MIROC5_amip_r1i1p1_199901-200812.nc', 'r')
...
os.chdir('E:/University/University/MSc/Models/climate-analysis/MIROC5-AMIP/reduced_datasets') #Home PC
#os.chdir('c:/Users/toha006/University/University/MSc/Models/climate-analysis/IPSL-CM5A-LR-AMIP/reduced_datasets') #Home PC
with h5py.File('2007_2008_miroc5.h5', 'w') as p:
